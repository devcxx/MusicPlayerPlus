#ifndef __HttpClient2_H__
#define __HttpClient2_H__
...
#define ZLOG(str) HttpClient2::getInstance()->zlog(__DATE__, __TIME__, __FILE__, __LINE__, __FUNCTION__, str);
...
public:
	...
	static HttpClient2 *getInstance();
